...
const (
	...
	InnerMsgId_InnerMsgMaintain   InnerMsgId = 4 //服务器维护
)
...
func (x *InnerMaintainReq) Reset() {
	*x = InnerMaintainReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internel_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *InnerMaintainReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InnerMaintainReq) ProtoMessage() {}

func (x *InnerMaintainReq) ProtoReflect() protoreflect.Message {
	mi := &file_internel_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InnerMaintainReq.ProtoReflect.Descriptor instead.
func (*InnerMaintainReq) Descriptor() ([]byte, []int) {
	return file_internel_proto_rawDescGZIP(), []int{7}
}

func (x *InnerMaintainReq) GetServerId() string {
	if x != nil {
		return x.ServerId
	}
	return ""
...
func (x *InnerMaintainReq) GetReqState() int32 {
	if x != nil {
		return x.ReqState
	}
	return 0
...
var file_internel_proto_rawDesc = []byte{
	...
	0x4c, 0x0a, 0x10, 0x49, 0x6e, 0x6e, 0x65, 0x72, 0x4d, 0x61, 0x69, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	...
	,
...
var file_internel_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_internel_proto_goTypes = []interface{}{
	...
	(*InnerMaintainReq)(nil),    // 8: protos.InnerMaintainReq
}
...
func file_internel_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internel_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InnerMaintainReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
