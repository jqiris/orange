...
// TUser [...]
type TUser struct {
	Userid  int64  `gorm:"primaryKey;column:userid;type:int unsigned;not null" json:"userid"`         // 用户ID
...
type TRoom struct {
	...
	UserID0    int64  `gorm:"column:user_id0;type:int;not null;default:0" json:"user_id0"`
