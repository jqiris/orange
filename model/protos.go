...
type MjHuData struct {
	...
	Pai           int32  `protobuf:"varint,2,opt,name=pai,proto3" json:"pai"`
	...
	Fan           int32  `protobuf:"varint,8,opt,name=fan,proto3" json:"fan"`
	...
	Numofgen      int32  `protobuf:"varint,13,opt,name=numofgen,proto3" json:"numofgen,omitempty"`
	Index         int32  `protobuf:"varint,14,opt,name=index,proto3" json:"index"`
}
