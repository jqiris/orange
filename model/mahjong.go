...
type MahjongRoom struct {
	...
	NumOfTurns int32  `gorm:"column:num_of_turns;type:int;not null;default:0" json:"num_of_turns"`    // 第几轮
	NextButton int32  `gorm:"column:next_button;type:int;not null;default:0" json:"next_button"`      // 下一位
	...
	UserScore0 int32  `gorm:"column:user_score0;type:int;not null;default:0" json:"user_score0"`
	...
	UserScore1 int32  `gorm:"column:user_score1;type:int;not null;default:0" json:"user_score1"`
	...
	UserScore2 int32  `gorm:"column:user_score2;type:int;not null;default:0" json:"user_score2"`
	...
	UserScore3 int32  `gorm:"column:user_score3;type:int;not null;default:0" json:"user_score3"`
}
